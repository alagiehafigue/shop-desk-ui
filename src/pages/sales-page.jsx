...
export function SalesPage() {
  ...
  useEffect(() => {
    ...
    if (!saleId || products.length === 0) return;
    ...
    async function loadSale() {
      try {
        ...
        if (isMounted) {
          setCheckoutFeedback({
            message: "Could not load pending sale. It may have been completed or cancelled.",
            tone: "error",
          });
          setActiveSaleId("error"); // Prevent interacting with an invalid sale
        }
      }
    }
